...
//        BeerService beerService = new BeerService();
    ...
    public void should_update_beer_volume() {
        ...
        when(this.beersMocked.findByNameAndType("Devassa", BeerType.PILSEN))
                    .thenReturn(Optional.of(beerInDatabase));
        ...
        when(this.beersMocked.save(beerToUpdate))
                    .thenReturn(beerMocked);

        final Beer beerUpdated = this.beerService.save(beerToUpdate);
